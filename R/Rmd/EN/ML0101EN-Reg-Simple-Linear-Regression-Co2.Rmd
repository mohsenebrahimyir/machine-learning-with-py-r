...
(
    ggplot(cdf)  + 
    aes(x="FUELCONSUMPTION_COMB", y="CO2EMISSIONS", color="ENGINESIZE")  + 
    geom_point() +
    theme_bw()
)
```
...
```{python}
sns.scatterplot(data=cdf, x='ENGINESIZE', y='CO2EMISSIONS',  hue='ENGINESIZE')
```
...
(
    ggplot(cdf)  + 
    aes(x="CYLINDERS", y="CO2EMISSIONS", color="ENGINESIZE")  + 
    geom_point() +
    labs(
        x = "Cylinders",
        y = "CO2"
    ) +
    theme_bw(base_family="IRANSans")
)
```
